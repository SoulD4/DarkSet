...
export default function DarkRankPage() {
  ...
  const RANK_IMGS: Record<string,string> = {
    'FRANGO':    '/ranks/frango.png',
    'INICIANTE': '/ranks/iniciante.png',
    'DEDICADO':  '/ranks/dedicado.png',
    'BRUTO':     '/ranks/bruto.png',
    'MONSTRO':   '/ranks/monstro.png',
    'MUTANTE':   '/ranks/mutante.png',
  };
