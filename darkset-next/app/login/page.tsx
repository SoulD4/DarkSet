...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    // Firebase será conectado na próxima etapa
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={handleGoogle} style={{
            ...
            padding: '13px', fontWeight: 700, fontSize: '.95rem',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '.75rem', marginBottom: '1rem' }}>
            ...
            {mode === 'cadastro' && (
              <div>
                <label style={{ fontSize: '.68rem', color: '#5a5a6a', textTransform: 'uppercase', letterSpacing: '.06em', display: 'block', marginBottom: '5px' }}>
                  Nome
                </label>
                <input
                  ...
                  style={{
                    ...
                    border: '1px solid #222227', borderRadius: '10px',
                    color: '#eaeaea', padding: '11px 13px',
